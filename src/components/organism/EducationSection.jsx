...
const EducationSection = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center w-4/5 m-2'>
      ...
      <div className='flex flex-wrap justify-center space-x-2 space-y-2 w-full mt-2'>
        <div>
          <Card
        ...
        <Card
          ...
          inside={
            <ul className='ml-5 list-disc'>
              ...
              <li>
                <strong>
                  Introducción a Data Science: Programación de Estadística con R
                </strong>{' '}
                (Coursera)
              ...
              <li>
                <strong>
                  Semillero formación inicial en el desarrollo de videojuegos
                </strong>{' '}
                (UDEA)
                <br /> {t('hourly-intensity')}: 40 {t('hours')} (2019)
              </li>
              <li>
                <strong>Certificación Inglés Nivel Avanzado</strong> (C1)
                (Centro Colombo Americano Medellín) (2018)
              </li>
              <li>
